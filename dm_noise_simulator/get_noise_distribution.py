...
kb = 1.380649E16 #ergs/kelvin
Ae = 14.137 * 100**2 #cm^2
Ts = 30 #kelvin
bandwidth = 183E3 #Hz

def autocorr_mean ():
    return kb*Ts/Ae * 1E-17 #μJy

def autocorr_stdv (int_time):
    return kb*Ts/(Ae*math.sqrt(2*int_time*bandwidth)) * 1E-17

def not_autocorr_stdv (int_time):
    return kb*Ts/(2*Ae*math.sqrt(int_time*bandwidth)) * 1E-17
